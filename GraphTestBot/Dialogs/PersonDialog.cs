...
{
    [Serializable]
    public class PersonDialog : IDialog<object>
    {
        ...
        {
            //await context.PostAsync("Welcome to the Person's finder!");

            //var hotelsFormDialog = FormDialog.FromForm(this.BuildHotelsForm, FormOptions.PromptInStart);
            //context.Call(hotelsFormDialog, this.ResumeAfterHotelsFormDialog);

            context.Fail(new NotImplementedException("Search using PersonDialog is not implemented and is instead being used to show context.Fail"));
        }
